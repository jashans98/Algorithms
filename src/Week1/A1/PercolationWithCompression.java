 ...
 * This is faster than the library provided straight out of Princeton's JAR
 */
public class PercolationWithCompression {
    ...
    public PercolationWithCompression(int n) {
        if (n <= 0)
    ...
    public static void main(String[] args) {
        PercolationWithCompression p = new PercolationWithCompression(3);
        p.open(1, 1);
        p.open(2, 2);
        p.open(2, 1);
        p.open(3, 1);
